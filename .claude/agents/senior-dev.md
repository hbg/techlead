---
name: senior-dev
description: Handles complex architectural decisions, cross-module refactors, security-sensitive code, performance optimization, debugging subtle issues, and any task requiring deep reasoning about system design.
model: opus
